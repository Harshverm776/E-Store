...
<html>
    ...
    <body background="images/book.jpg">
        ...
        ResultSet rs = statement.executeQuery("  select bookid, count(bookid) as quantity from buyproduct where B_email='"+s+"' group by bookid");
        %>
                ...
                if(rs1!=null)
        {
            ...
            System.out.println("else part");
               out.print("<script> alert('NO ITEMS'); location='buyerpage.jsp';</script>");
            }
%>
                </tbody>
              </table>
