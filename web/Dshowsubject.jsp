...
<html>
    ...
    <body background="images/BookDetails.jpg">
        ...
        <div id="home"><a href=sellerpage.jsp><b>Seller-Home</b></a></div>
        <div id="sub">    
        <div class="alert alert-primary" role="alert">
            <form action="Dshowbook.jsp"><input type="text" name="sub" value="English" hidden>
                    <button class="btn btn-primary">English</button></form>
          </div>
          <div class="alert alert-secondary" role="alert">
              <form action="Dshowbook.jsp"><input type="text" name="sub" value="Physics" hidden>
                  <button class="btn btn-secondary">Physics</button></form>
          </div>
          <div class="alert alert-success" role="alert">
              <form action="Dshowbook.jsp"><input type="text" name="sub" value="Computer Science" hidden>
                  <button class="btn btn-success">Computer Science</button></form>
          </div>
          <div class="alert alert-danger" role="alert">
              <form action="Dshowbook.jsp"><input type="text" name="sub" value="Chemistry" hidden>
                  <button class="btn btn-danger">Chemistry</button></form>
          </div>
          <div class="alert alert-warning" role="alert">
                <form action="Dshowbook.jsp"><input type="text" name="sub" value="Biology" hidden>
                    <button class="btn btn-warning">Biology</button></form>
          </div>
          <div class="alert alert-info" role="alert">
              <form action="Dshowbook.jsp"><input type="text" name="sub" value="Maths" hidden>
                  <button class="btn btn-info">Maths</button></form>
          </div>
          <div class="alert alert-light" role="alert">
              <form action="Dshowbook.jsp"><input type="text" name="sub" value="Informatics Practices" hidden>
